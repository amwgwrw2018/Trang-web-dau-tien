...
<title><fmt:message key="Car"/></title>
<style type="text/css">
...
<h2 style="border-bottom: 1px dotted black;"><fmt:message key="Car"/></h2>
...
<div  id="khungChiTiet">
  <div id="tieuDeChiTiet" class="well"><h3><img src="image/carIcon.png" width="40" height="40"><fmt:message key="Car"/> </h3></div>
...
<li>
<a onclick="getPage(<%=i+8*(i-1)%>,<%=i*8%>,'CarProducts')"><%=i %></a>
</li>
<%} %>
  </ul>
</div>
...
<div class="fb-comments" data-href="http://localhost:8080/DeTaiWEB/MoHinhXeCo.jsp" data-width="100%" data-numposts="5" style="margin-left: auto;"></div>
</div>
</body>
</html>