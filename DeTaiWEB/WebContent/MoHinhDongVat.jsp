...
<title><fmt:message key="Animal"/></title>
<style type="text/css">
...
<h2 style="border-bottom: 1px dotted black;"><fmt:message key="Animal"/></h2>
...
<div  id="khungChiTiet">
  <div id="tieuDeChiTiet" class="well"><h3><img src="image/animal.png" width="40" height="40"><fmt:message key="Animal"/></h3></div>
   <div id="detailForEachType">
<%for(MatHang mh:list){ %>
  <div class="AnimalProducts">
...
<div id="phanTrangAnimal">
  <ul class="pagination">
  
<%for(int i =1;i<=list.size()/8+1;i++){ %>
<li>
<a onclick="getPage(<%=i+8*(i-1)%>,<%=i*8%>,'AnimalProducts')"><%=i %></a>
</li>
<%} %>
  </ul>
</div>
...
<div class="fb-comments" data-href="http://localhost:8080/DeTaiWEB/MoHinhDongVat.jsp" data-width="100%" data-numposts="5"></div>
</div>
</body>
</html>